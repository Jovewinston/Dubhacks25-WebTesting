...
def get_all_interactive_elements(page) -> list:
    ...
    #     'input', 'textarea','select','fieldset','legend','summary','details','buttonmenu',       
    #     'tablist', 'treeitem','gridrow','gridcolumnheader','gridrowheader', 'application', 
    #     'progressbar', 'spinbutton', 'scrollbar', 'label'         
    # ]
    interactive_roles = [
    # Standard ARIA widget roles
    'button', 'link', 'checkbox', 'radio', 'textbox', 'switch', 'combobox',
    'listbox', 'option', 'slider', 'spinbutton', 'menu', 'menuitem',
    'menuitemcheckbox', 'menuitemradio', 'tab', 'tablist', 'tabpanel',
    'toolbar', 'tree', 'treeitem', 'grid', 'gridcell', 'row', 'rowgroup',
    'cell', 'columnheader', 'rowheader', 'progressbar', 'scrollbar',
    'separator', 'tooltip', 'dialog', 'alertdialog', 'region', 'group',
    'alert', 'status', 'searchbox', 'application', 'feed', 'banner',
    'navigation', 'contentinfo', 'form',

    # # Native HTML interactives
    # 'input', 'textarea', 'select', 'fieldset', 'legend', 'summary', 'details',
    # 'datalist', 'optgroup', 'output', 'label', 'meter', 'time',

    # # Composite & advanced ARIA patterns
    # 'gridrow', 'gridcolumnheader', 'gridrowheader', 'rowheader', 'columnheader',
    # 'presentation', 'note', 'buttonmenu', 'menuitemsubmenu', 'optiongroup',
    # 'tabpanel', 'treegrid',

    # # Rare but valid ARIA widgets
    # 'directory', 'math', 'img', 'term', 'definition', 'figure', 'code',
