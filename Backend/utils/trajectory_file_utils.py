...
def update_trajectory(dirs: Dict[str, str], step_idx: int, screenshot: str, axtree: str, action_code: str, 
    ...
    # Get wrong_behavior from llm_output
    wrong_behavior = llm_output.get('wrong_behavior', False) if llm_output else False
